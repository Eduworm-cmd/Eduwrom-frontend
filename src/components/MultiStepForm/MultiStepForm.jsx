...
export const MultiStepForm = ({stepperSidebar = [], stepContent = [], title, description}) => {
  ...
  return (
    <div className="bg-white text-slate-700 shadow-md border min-h-[500px] transition-all duration-300 ease-in-out px-3 md:px-10 py-6 w-full rounded-xl">
      ...
      <div className="mt-4 flex md:flex-row flex-col items-center px-0 md:px-8">
