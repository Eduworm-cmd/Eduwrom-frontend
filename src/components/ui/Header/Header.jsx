      ...
      <div className="flex justify-between items-center w-full px-8 py-4 border-b max-md:px-4">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-gray-500 text-md font-semibold max-md:text-sm" >Physics</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-4 flex-col">
          ...
          <select
            id="countries"
            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-sky-600 focus:border-sky-600 block w-full max-md:w-[80%] p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-sky-600 dark:focus:border-sky-600"
          >
