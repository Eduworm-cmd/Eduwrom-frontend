  ...
  return (
    <form className="max-w-4xl mx-auto p-6" onSubmit={handleSubmit}>
      ...
      <div className="mb-6">
        ...
        <div className="border-2 border-dashed border-gray-300 rounded-lg p-4 flex flex-col items-center justify-center gap-4">
          {logoPreview && (
            <>
              <img
                src={logoPreview}
          ...
          <label className="cursor-pointer w-full text-center flex items-center justify-center gap-2 bg-blue-100 text-blue-700 px-4 py-2 rounded-lg hover:bg-blue-200 transition">
